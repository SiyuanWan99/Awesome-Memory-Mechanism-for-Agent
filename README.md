...
|---|---|---|---|---|---|
| 2024 | arXiv | DeepSeek-V3 Technical Report | Large-scale MoE LLM with training/serving optimizations |  | [PDF](https://arxiv.org/abs/2412.19437) |
| 2022 | OpenAI | Introducing ChatGPT | Large-scale parametric conversational ability; baseline context for memory discussions |  | [PDF](https://openai.com/blog/chatgpt) |
<!-- PNS:END -->
